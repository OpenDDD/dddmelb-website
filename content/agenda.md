    ...
    <table class="agenda-row table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="session session-4"><strong>Kieran Jacobsen</strong><br><em>The Boring Security Talk</em></td>
                <td class="session session-4"><strong>Brendan Richards</strong><br><em>Full Stack Rx - Using Redux Patterns on the Server Side with .Net Core, and SignalR</em></td>
                <td class="session session-4"><strong>Prakriti Mateti</strong><br><em>7 lessons in 7 years</em></td>
                <td class="session session-4">
                  <a href="#" class="orange-room" data-toggle="modal" data-target="#agenda-modal">
            ...
            <tr>
                ...
                <td class="session session-4"><strong>Damian Brady</strong><br><em>Intro to Machine Learning</em></td>
                <td class="session session-4"><strong>Allison Ravenhall</strong><br><em>Inclusive front-end development with WCAG 2.1</em></td>
                <td class="session session-4"><strong>Abhaya Chauhan</strong><br><em>What has 4 years of AWS Microservices taught me?</em></td>
                <td class="session session-4">
                  <a href="#" class="orange-room" data-toggle="modal" data-target="#agenda-modal">
            ...
            <tr>
                ...
                <td class="session session-4"><strong>Rob Crowley</strong><br><em>Service Meshes - Powering the next wave of microservice architectures</em></td>
                <td class="session session-4"><strong>Ryan Preece</strong><br><em>Modern JavaScript For Web Dinosaurs</em></td>
                <td class="session session-4"><strong>Amanda Dean</strong><br><em>Modern Testing for Modern Developers</em></td>
                <td class="session session-4">
                 <a href="#" class="orange-room" data-toggle="modal" data-target="#agenda-modal">
            ...
            <tr>
                ...
                <td class="session session-4" rowspan="2"><strong>Anthony Borton</strong><br><em>How Microsoft does devops</em></td>
                <td class="session session-4" rowspan="2"><strong>Aaron Powell</strong><br><em>Securing Single Page Applications</em></td>
                <td class="session session-4" rowspan="2"><strong>Tamma Waddell</strong><br><em>Railway Oriented Programming: C# Edition</em></td>
                <td class="session session-4">
                  <a href="#" class="orange-room" data-toggle="modal" data-target="#agenda-modal">
